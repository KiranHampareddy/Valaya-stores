...
const MASTER_DATABASE = { 
    rawMaterials: [
        { id: 'rm_1', name: 'Bangles Normal base 1 Box', unit: 'Pcs', qty: 1, cost: 120, stock: 0 },
        { id: 'rm_2', name: 'Bangles Flat base 1 Box', unit: 'Pcs', qty: 1, cost: 130, stock: 0 },
        { id: 'rm_3', name: 'Thread 1pc', unit: 'Reel', qty: 1, cost: 18, stock: 0 },
        { id: 'rm_4', name: 'Thread 1 box (10pcs)', unit: 'Pcs', qty: 10, cost: 160, stock: 0 },
        { id: 'rm_5', name: 'Fevicryl Glue Cone 1pc', unit: 'Pcs', qty: 1, cost: 15, stock: 0 },
        { id: 'rm_5b', name: 'Fevicryl Glue Tube 30g', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_6', name: 'B7000 Glue 1pc 50ml', unit: 'Pcs', qty: 1, cost: 60, stock: 0 },
        { id: 'rm_7', name: 'Glue pen and stick', unit: 'Pcs', qty: 1, cost: 40, stock: 0 },
        { id: 'rm_8', name: 'Thread Cutter 1pc', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_9', name: 'Nose plier Big 1 pc', unit: 'Pcs', qty: 1, cost: 80, stock: 0 },
        { id: 'rm_10', name: 'Wire cutter Big 1pc', unit: 'Pcs', qty: 1, cost: 80, stock: 0 },
        { id: 'rm_11', name: 'Punch hole big 1pc', unit: 'Pcs', qty: 1, cost: 150, stock: 0 },
        { id: 'rm_12', name: 'White and Gold kundans 10g', unit: 'Grm', qty: 10, cost: 15, stock: 0 },
        { id: 'rm_13', name: 'White and Gold kundans rare shapes 10g', unit: 'Grm', qty: 10, cost: 18, stock: 0 },
        { id: 'rm_14', name: 'Pearl white and Pearl Gold 10g', unit: 'Grm', qty: 10, cost: 18, stock: 0 },
        { id: 'rm_15', name: 'Kundans colors matt 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_16', name: 'Kundans colors glossy 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_17', name: 'Square kundans colors 1st quality 10g', unit: 'Grm', qty: 10, cost: 45, stock: 0 },
        { id: 'rm_18', name: 'Square kundans 2nd quality 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_19', name: 'Moon shape matt 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_20', name: 'Stone chain white and gold 1 mtr', unit: 'Mtr', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_21', name: 'Stone chain colors 1mtr', unit: 'Mtr', qty: 1, cost: 30, stock: 0 },
        { id: 'rm_22', name: 'Ball chain 1mtr', unit: 'Mtr', qty: 1, cost: 9, stock: 0 },
        { id: 'rm_23', name: 'Coins 1st quality 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_24', name: 'Zardhosi 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_25', name: 'Chakri gold 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_26', name: 'Jargon stones 10g', unit: 'Grm', qty: 10, cost: 35, stock: 0 },
        { id: 'rm_27', name: 'Center clip small', unit: 'Pcs', qty: 1, cost: 8, stock: 0 },
        { id: 'rm_28', name: 'Center clip Medium', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_29', name: 'Center clip Big', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_30', name: 'Tic tac clips Black 6 pairs', unit: 'Pcs', qty: 6, cost: 36, stock: 0 },
        { id: 'rm_31', name: 'Tic tac Golden 6 pairs', unit: 'Pcs', qty: 6, cost: 60, stock: 0 },
        { id: 'rm_32', name: 'Saree pin 1 dozen 12pcs', unit: 'Pcs', qty: 12, cost: 80, stock: 0 },
        { id: 'rm_33', name: 'Saree pin ½ dozen 6pcs', unit: 'Pcs', qty: 6, cost: 40, stock: 0 },
        { id: 'rm_34', name: 'Saree pin Metal 10pcs', unit: 'Pcs', qty: 10, cost: 40, stock: 0 },
        { id: 'rm_35', name: 'Hair pin 1 set (1st quality)', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_36', name: 'Head band metal 3mm and 5mm 1 pc', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_37', name: 'MDF round small 10pcs', unit: 'Pcs', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_38', name: 'MDF round medium 10pcs', unit: 'Pcs', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_39', name: 'MDF round Large 10pcs', unit: 'Pcs', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_40', name: 'MDF round Extra-large 10pcs', unit: 'Pcs', qty: 10, cost: 35, stock: 0 },
        { id: 'rm_41', name: 'MDF Other shapes 10pcs', unit: 'Pcs', qty: 10, cost: 40, stock: 0 },
        { id: 'rm_42', name: 'Black rubber band 1pc', unit: 'Pcs', qty: 1, cost: 3, stock: 0 },
        { id: 'rm_43', name: 'Band Attacher 1pc', unit: 'Pcs', qty: 1, cost: 3, stock: 0 },
        { id: 'rm_44', name: 'Finger ring base 5 pcs', unit: 'Pcs', qty: 5, cost: 10, stock: 0 },
        { id: 'rm_45', name: 'finger Ring base Tarnish finish 1st quality 5 pc', unit: 'Pcs', qty: 5, cost: 50, stock: 0 },
        { id: 'rm_46', name: 'Jhumka base 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_47', name: 'Donut ring 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_48', name: 'Metal stud base 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_49', name: 'Stud stopper 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_50', name: 'Ring stud base 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_51', name: 'Clutch clips 5 pcs small', unit: 'Pcs', qty: 5, cost: 25, stock: 0 },
        { id: 'rm_52', name: 'Clutch clips 5 pcs big', unit: 'Pcs', qty: 5, cost: 30, stock: 0 },
        { id: 'rm_53', name: 'Alligator clips small 1pc', unit: 'Pcs', qty: 1, cost: 3, stock: 0 },
        { id: 'rm_54', name: 'Alligator clip medium 1 pc', unit: 'Pcs', qty: 1, cost: 5, stock: 0 },
        { id: 'rm_55', name: 'Gier wire 1 roll pc', unit: 'Pcs', qty: 1, cost: 45, stock: 0 },
        { id: 'rm_56', name: 'Neck piece Dori 1pcs', unit: 'Pcs', qty: 1, cost: 15, stock: 0 },
        { id: 'rm_57', name: 'Gear lock beads 5g', unit: 'Grm', qty: 5, cost: 50, stock: 0 },
        { id: 'rm_58', name: 'Eye pin 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_59', name: 'Jump ring 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_60', name: 'S hook 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_61', name: 'Wax brown sheet 5pcs', unit: 'Pcs', qty: 5, cost: 10, stock: 0 },
        { id: 'rm_62', name: 'OHP sheet 1 pc', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_63', name: 'Loreals 10g', unit: 'Grm', qty: 10, cost: 35, stock: 0 },
        { id: 'rm_64', name: 'Pearl chain 1 mtr', unit: 'Mtr', qty: 1, cost: 70, stock: 0 },
        { id: 'rm_65', name: 'U pin 5 pcs', unit: 'Pcs', qty: 5, cost: 10, stock: 0 },
        { id: 'rm_66', name: 'Bracelet 1 pc', unit: 'Pcs', qty: 1, cost: 15, stock: 0 },
        { id: 'rm_67', name: 'Crystal tec Elastic 1pc', unit: 'Pcs', qty: 1, cost: 25, stock: 0 },
        { id: 'rm_68', name: 'A1 zari thread 1pc', unit: 'Reel', qty: 1, cost: 18, stock: 0 },
        { id: 'rm_69', name: 'Gimp wire 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_70', name: 'Felt sheet 1 pc A4 sheet size', unit: 'Pcs', qty: 1, cost: 35, stock: 0 },
        { id: 'rm_71', name: 'Leather sheet ½ A4 sheet size 1pc', unit: 'Pcs', qty: 1, cost: 25, stock: 0 },
        { id: 'rm_72', name: 'Sugar beads matt 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_73', name: 'Sugar beads glossy 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_74', name: 'Curdhana beads 10g', unit: 'Grm', qty: 10, cost: 15, stock: 0 },
        { id: 'rm_75', name: 'Salli tube 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_76', name: 'Salli tube long 10g', unit: 'Grm', qty: 10, cost: 15, stock: 0 },
        { id: 'rm_77', name: 'Side hole sequence 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_78', name: 'sequence 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_79', name: 'Sequence double shade 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_80', name: 'Stocking cloth small 1pc', unit: 'Pcs', qty: 1, cost: 5, stock: 0 },
        { id: 'rm_81', name: 'Stocking cloth big 1pc', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_82', name: 'Stocking wire 5pcs', unit: 'Pcs', qty: 5, cost: 10, stock: 0 },
        { id: 'rm_83', name: 'Shells 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_84', name: 'Shell’s gold outline 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_85', name: 'Daisy flower 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_86', name: 'Lotus petal beads 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_87', name: 'Satin ribbon role 1 inch 1pc', unit: 'Pcs', qty: 1, cost: 100, stock: 0 },
        { id: 'rm_88', name: 'Satin ribbon role ½ inch 1pc', unit: 'Pcs', qty: 1, cost: 90, stock: 0 },
        { id: 'rm_89', name: 'Organza ribbon role 1inch 1pc', unit: 'Pcs', qty: 1, cost: 100, stock: 0 },
        { id: 'rm_90', name: 'Organza ribbon role ½ inch 1pc', unit: 'Pcs', qty: 1, cost: 90, stock: 0 },
        { id: 'rm_91', name: 'Pollens 1 punch', unit: 'Pcs', qty: 1, cost: 25, stock: 0 },
        { id: 'rm_92', name: 'Net cloth 1mtr', unit: 'Mtr', qty: 1, cost: 40, stock: 0 },
        { id: 'rm_93', name: 'Zardhosi needle 1 packet', unit: 'Pcs', qty: 1, cost: 50, stock: 0 },
        { id: 'rm_94', name: 'French knot needle 1 packet', unit: 'Pcs', qty: 1, cost: 45, stock: 0 },
        { id: 'rm_95', name: 'Flower antique cap 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_96', name: 'Crystal beads 1-line 4mm', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_97', name: 'Aari wooden ring 10-inch 1pc', unit: 'Pcs', qty: 1, cost: 50, stock: 0 },
        { id: 'rm_98', name: 'Mini Iron Box 1 pc', unit: 'Pcs', qty: 1, cost: 700, stock: 0 },
        { id: 'rm_99', name: 'Cone Zari thread 1 pc', unit: 'Reel', qty: 1, cost: 100, stock: 0 },
        { id: 'rm_100', name: 'UV Resin 10g', unit: 'Grm', qty: 10, cost: 120, stock: 0 },
        { id: 'rm_101', name: 'UV Lamp 1pc', unit: 'Pcs', qty: 1, cost: 150, stock: 0 },
        { id: 'rm_102', name: 'Resin Tape', unit: 'Pcs', qty: 1, cost: 120, stock: 0 },
        { id: 'rm_103', name: 'Dry flower 1box', unit: 'Pcs', qty: 1, cost: 130, stock: 0 },
        { id: 'rm_104', name: 'Drilling holes machine', unit: 'Pcs', qty: 1, cost: 650, stock: 0 },
        { id: 'rm_105', name: 'Soldering Machine 1pc', unit: 'Pcs', qty: 1, cost: 180, stock: 0 },
        { id: 'rm_106', name: 'Gungroo Beads 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_107', name: '3 hole connectors 1pc', unit: 'Pcs', qty: 1, cost: 3, stock: 0 },
        { id: 'rm_108', name: '5 hole connectors 1 pc', unit: 'Pcs', qty: 1, cost: 5, stock: 0 },
        { id: 'rm_109', name: 'Big center neck connector 1 pc', unit: 'Pcs', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_110', name: 'Canvas sheet ½ mtr', unit: 'Mtr', qty: 0.5, cost: 80, stock: 0 },
        { id: 'rm_111', name: '200 GSM paper A4 sheet 1pc', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_112', name: 'Cotton Thread 1 pc', unit: 'Reel', qty: 1, cost: 35, stock: 0 },
        { id: 'rm_113', name: 'Gotta Patti lace 5mtr', unit: 'Mtr', qty: 5, cost: 25, stock: 0 },
        { id: 'rm_114', name: 'White marking pencil 1 pc', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_115', name: 'Nylon Thread 1pc', unit: 'Reel', qty: 1, cost: 15, stock: 0 },
        { id: 'rm_116', name: 'Cut out shapes 10g', unit: 'Grm', qty: 10, cost: 25, stock: 0 },
        { id: 'rm_117', name: 'Zardhosi Nakshi 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_118', name: 'Antique pieces like ganesh 10g', unit: 'Grm', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_119', name: 'Plastic Round beads 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_120', name: 'Mirror 10g', unit: 'Grm', qty: 10, cost: 20, stock: 0 },
        { id: 'rm_121', name: 'Bangle plastic box round small', unit: 'Pcs', qty: 1, cost: 5, stock: 0 },
        { id: 'rm_122', name: 'Bangle plastic box round big 1 box', unit: 'Pcs', qty: 1, cost: 10, stock: 0 },
        { id: 'rm_123', name: '5*8 size drop clip stones 1 pc', unit: 'Pcs', qty: 1, cost: 3, stock: 0 },
        { id: 'rm_124', name: '10*6 size drop clip stone 1pc', unit: 'Pcs', qty: 1, cost: 4, stock: 0 },
        { id: 'rm_125', name: '13*8 size drop clip stone 1pc', unit: 'Pcs', qty: 1, cost: 6, stock: 0 },
        { id: 'rm_126', name: '10*5 size eye clip stone 1pc', unit: 'Pcs', qty: 1, cost: 5, stock: 0 },
        { id: 'rm_127', name: '15*7 size eye clip stone 1pc', unit: 'Pcs', qty: 1, cost: 8, stock: 0 },
        { id: 'rm_128', name: '10*5 size tube clip stone 1pc', unit: 'Pcs', qty: 1, cost: 6, stock: 0 },
        { id: 'rm_129', name: 'Grey packing cover 6*8 size 5pcs', unit: 'Pcs', qty: 5, cost: 15, stock: 0 },
        { id: 'rm_130', name: 'Grey packing cover 8*10 size 5pcs', unit: 'Pcs', qty: 5, cost: 30, stock: 0 },
        { id: 'rm_131', name: 'Grey packing cover 10*14 size 5pcs', unit: 'Pcs', qty: 5, cost: 40, stock: 0 },
        { id: 'rm_132', name: '24 partition box 1 pc', unit: 'Pcs', qty: 1, cost: 200, stock: 0 },
        { id: 'rm_133', name: 'Clipstones 12ss white and gold 1 groos 5g', unit: 'Grm', qty: 5, cost: 35, stock: 0 },
        { id: 'rm_134', name: 'Clipstones 14ss white and gold 1 groos 5g', unit: 'Grm', qty: 5, cost: 35, stock: 0 },
        { id: 'rm_135', name: 'Clipstones 28ss White and gold 1 groos 5g', unit: 'Grm', qty: 5, cost: 35, stock: 0 },
        { id: 'rm_136', name: 'Clipstones colors 1 groos 5g', unit: 'Grm', qty: 5, cost: 45, stock: 0 },
        { id: 'rm_137', name: 'Clipstones oval shape dollar 1 pc', unit: 'Pcs', qty: 1, cost: 25, stock: 0 },
        { id: 'rm_138', name: 'Clipstone 10*14 size Rectangle1pc', unit: 'Pcs', qty: 1, cost: 9, stock: 0 },
        { id: 'rm_139', name: 'Clipstone 10*8 Rectangle size 1 pc', unit: 'Pcs', qty: 1, cost: 6, stock: 0 },
        { id: 'rm_140', name: 'Clipstone 10*14 size Oval 1pc', unit: 'Pcs', qty: 1, cost: 9, stock: 0 },
        { id: 'rm_141', name: 'Clipstone 10*8 Oval size 1 pc', unit: 'Pcs', qty: 1, cost: 6, stock: 0 },
        { id: 'rm_142', name: 'Jasmine bud Premium Quality 1 box 100 pcs', unit: 'Pcs', qty: 100, cost: 600, stock: 0 },
        { id: 'rm_143', name: 'Scrunchies Elastic 5 mtr', unit: 'Mtr', qty: 5, cost: 100, stock: 0 },
        { id: 'rm_144', name: 'Plain Satin cloth 1 mtr', unit: 'Mtr', qty: 1, cost: 150, stock: 0 },
        { id: 'rm_145', name: 'Printed Satin 1 mtr', unit: 'Mtr', qty: 1, cost: 230, stock: 0 },
        { id: 'rm_146', name: 'Printed cotton Fabric 1 mtr', unit: 'Mtr', qty: 1, cost: 250, stock: 0 },
        { id: 'rm_147', name: 'Designer lace 1 mtr', unit: 'Mtr', qty: 1, cost: 20, stock: 0 },
        { id: 'rm_148', name: 'MDF Donut Very small 10pcs', unit: 'Pcs', qty: 10, cost: 30, stock: 0 },
        { id: 'rm_149', name: 'MDF Donut Medium 10pcs', unit: 'Pcs', qty: 10, cost: 40, stock: 0 },
        { id: 'rm_150', name: 'MDF Donut Big 10pcs', unit: 'Pcs', qty: 10, cost: 55, stock: 0 },
        { id: 'rm_151', name: 'MDF Donut Large 10pcs', unit: 'Pcs', qty: 10, cost: 65, stock: 0 },
        { id: 'rm_152', name: 'Silk thread jewelry kit no 1', unit: 'Pcs', qty: 1, cost: 500, stock: 0 },
        { id: 'rm_153', name: 'Silk thread jewelry kit no 2', unit: 'Pcs', qty: 1, cost: 1000, stock: 0 },
        { id: 'rm_154', name: 'Silk thread jewelry kit no 3', unit: 'Pcs', qty: 1, cost: 1500, stock: 0 },
        { id: 'rm_155', name: 'Silk thread jewelry kit no 4', unit: 'Pcs', qty: 1, cost: 2000, stock: 0 },
        { id: 'rm_156', name: 'Silk thread jewelry kit no 5', unit: 'Pcs', qty: 1, cost: 1000, stock: 0 },
        { id: 'rm_157', name: 'Brooches kit', unit: 'Pcs', qty: 1, cost: 1200, stock: 0 },
        { id: 'rm_158', name: 'Fabric Jewelry kit', unit: 'Pcs', qty: 1, cost: 1400, stock: 0 },
        { id: 'rm_159', name: 'Cotton Thread Jewelry kit', unit: 'Pcs', qty: 1, cost: 1000, stock: 0 },
        { id: 'rm_160', name: 'Resin Jewelry kit', unit: 'Pcs', qty: 1, cost: 1200, stock: 0 },
        { id: 'rm_161', name: 'Invisible Jewelry kit', unit: 'Pcs', qty: 1, cost: 500, stock: 0 },
        { id: 'rm_162', name: 'Jothika set Jewelry kit', unit: 'Pcs', qty: 1, cost: 500, stock: 0 },
        { id: 'rm_163', name: 'Silk Thread Business Kit 1', unit: 'Pcs', qty: 1, cost: 10000, stock: 0 },
        { id: 'rm_164', name: 'Silk Thread Business Kit 2', unit: 'Pcs', qty: 1, cost: 6000, stock: 0 }
    ],
    labor: [],
    packing: []
};
